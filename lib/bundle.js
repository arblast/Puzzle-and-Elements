...
/***/ function(module, exports, __webpack_require__) {
	...
	class Board {
	  ...
	  constructor(width, height, row, col, offset=0, canvas) {
	    ...
	    this.colorMatches = {water: 0, wind: 0, electric: 0, wood: 0, fire: 0};
	    this.matchCount = 0;
	  ...
	  populate(){
	    this.grid.forEach((row, i) => {
	      for ( var j=0; j < row.length; j++) {
	        const x = +(j*this.width/this.col + this.offset).toFixed(7);
	        const y = +(i*this.height/this.row + this.offset).toFixed(7);
